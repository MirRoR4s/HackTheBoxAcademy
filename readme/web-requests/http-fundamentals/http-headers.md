---
description: https://academy.hackthebox.com/module/35/section/223
---
...
```
 MirRoR4s@htb[/htb]$ curl -I https://www.inlanefreight.com
 ​
...
```
 MirRoR4s@htb[/htb]$ curl https://www.inlanefreight.com -A 'Mozilla/5.0'
 ​
...
Finally, let's see how we can preview the HTTP headers using the browser devtools. Just as we did in the previous section, we can go to the `Network` tab to view the different requests made by the page. We can click on any of the requests to view its details: ![devtools\_network\_requests\_details](https://academy.hackthebox.com/storage/modules/35/devtools\_network\_requests\_details.jpg)
...
Connected to htb-hxuoy5hlhn:1 (htb-ac-748864)
