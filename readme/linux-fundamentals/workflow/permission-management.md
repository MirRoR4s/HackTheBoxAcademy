---
description: https://academy.hackthebox.com/module/18/section/83
---
...
To execute files within the directory, a user needs to `execute` permissions on the corresponding file. To modify the contents of a directory (create, delete, or rename files and subdirectories), the user needs `write` permissions on the directory.
